...
npm i body-parser для парсинга полей как обьекты JavaScript

npm i cors morgan

cors нужен для того чтобы наш сервер мог обрабатывать cors запросы например если клиент находится на другом домене мы сможем отвечать нашим сервером

morgan служит для того что бы могли более красиво логировать определенные запросы т.е.. смотреть что происходит с сервером в данный момент

Устанавливаем mongoose  npm i mongoose для работы с базой данных mongoDB
