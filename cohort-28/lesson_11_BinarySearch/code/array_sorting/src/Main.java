...
public class Main {
    public static void main(String[] args) {
        ...
        // Способов сортировки всего два математический и по алфавиту - по латинскому или национальному
        // Есть еше один способ - по времени, если есть метка времени.


        // Алгоритм:
        // "пузырьковая сортировка" bouble sort) - меньший элемент "всплывает" в начало (левый конец) массива.
        ...
        // цикл в цикле - первый цикл проходит по массиву, второй (внутренний) ишет минимальный из оставшихся элементов
        ...
        for (int i = 0; i < numbers.length; i++) {
            min = numbers[i];
            indexOfMin = i;
            //обойти все элементы правее текушего
